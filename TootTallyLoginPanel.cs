...
namespace TootTallyAccounts
{
    public class TootTallyLoginPanel
    {
        ...
        public TootTallyLoginPanel()
        {
            ...
            #region MainMenu
            _titleText = GameObjectFactory.CreateSingleText(_topLeftContainer.transform, "WelcomeText", "Welcome to toottally", Color.white);
            ...
            GameObjectFactory.CreateDefaultButton(_menuMain.transform, Vector2.zero, new Vector2(250, 40), "Don't Show Again", 20, "DontShowAgain", OnDontShowAgainClick);
        ...
        public void Show()
        {
            ...
            TootTallyAnimationManager.AddNewScaleAnimation(_mainPanelBG, Vector3.one, 1f, GetSecondDegreeAnimation(1.5f));
        }

        public void Hide()
        {
            _loadingIcon?.StopRecursiveAnimation(true);
            TootTallyAnimationManager.AddNewScaleAnimation(_mainPanelBG, Vector2.zero, .7f, new SecondDegreeDynamicsAnimation(1.75f, 0.75f, 1f), sender => _gameObject.SetActive(false));
        }
